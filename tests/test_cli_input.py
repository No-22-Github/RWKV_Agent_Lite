...
def mock_prompt_session():
    ...
    with (
        patch("rvoone.cli.commands._PROMPT_SESSION", mock_session),
        patch("rvoone.cli.commands.patch_stdout"),
    ):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with (
        patch("rvoone.cli.commands.PromptSession") as MockSession,
        patch("rvoone.cli.commands.FileHistory") as MockHistory,
